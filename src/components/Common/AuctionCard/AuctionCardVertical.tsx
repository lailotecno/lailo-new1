...
const AuctionCardVertical: React.FC<AuctionCardProps> = ({
  item,
  onToggleFavorite,
  onViewDetails
}) => {
  ...
  return (
    <div className="flex flex-col rounded-lg shadow-sm hover:shadow-md transition-all duration-200 bg-white p-5 border border-gray-200 hover:border-gray-300">
      ...
      {/* Bloco textual (mesmo layout do horizontal) */}
      ...
      {/* Divider atravessando todo o card */}
      <div className="h-px w-full bg-gray-200 my-4" />

      {/* Parte inferior: Tags + Data + Botão */}
...
export default AuctionCardVertical;